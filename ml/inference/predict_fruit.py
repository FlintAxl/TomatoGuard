...
# Map class indices
class_indices = {0: "anthracnose", 1: "blossom_end_rot", 2: "healthy", 3: "bckeye_rot", 4: "gray_mold"}
    ...
    for root, dirs, files in os.walk(folder_path):
        for file in files:
            if file.lower().endswith((".jpg", ".png", ".jpeg")):
                ...
                disease, conf = predict_fruit(img_path)
...
if __name__ == "__main__":
    test_folder = "../data/processed_split/test/fruit"
